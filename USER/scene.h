 ...
 * @LastEditors: xw.qu
 * @LastEditTime: 2023-09-27 16:02:12
...
#define __SCENE_H__
#include "module.h"
#define SCENE_NUB_SIGNLE  64
#define SCENE_NUB  64*SCENE_NAME_NUB
#define SCENE_NAME_NUB 64
...
#define SINGLE_NAME_SCENC_INFOR_SIZE  (SCENE_NUB_SIGNLE*SCENC_INFOR_T_SIZE)
...
#define SCENE_INFOR_FLASH_ADR_END     (SCENE_INFOR_FLASH_ADR_SATRT  + SCENE_NUB*SCENC_INFOR_T_SIZE)
